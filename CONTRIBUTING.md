...
1. Confirm the build is [passing in travis](https://travis-ci.org/cooldy555/onicolae2017)
...
2. Push a release commit
   ...
   2. Rename the old Master section like:
          ## [1.0.5](https://github.com/cooldy555/onicolae2017/releases/tag/1.0.5)
...
4. Create Carthage binaries
   ...
   2. `carthage archive onicolae2017`
